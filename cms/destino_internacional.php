                    ...
                    <div class="col-12 col-md-4">
                        <div class="form-group" id="marcoborder">
                          ...
                          <img src="<?php echo $dataDestInternacional['foto']; ?>" id="imgLogo">
                            ...
                            <a href="borrarDestino.php?id=<?php echo $dataDestInternacional['id']; ?>&tipoDestino=Internacional" class="btn btn-danger" onclick="return confirm('Estás seguro que desea eliminar el Destino Internacional?');">Borrar</a>
                        </div>
                    </div>
                  ...
                  <div class="modal-content">
                    <div class="modal-header" style="background-color: #0190e0  !important;">
                      <h6 class="modal-title" style="color: #fff; text-align: center;">
                          Modificar información del Destino Internacional
                      </h6>
